...
export default {
    ...
    computed: {
        ...
        //     }
        // },
        // get_library_link(library) {
        //     return () => {
        //         return `library/${library.hid}`
        //     }
        // },
        get_link() {
            if (process.browser) {
