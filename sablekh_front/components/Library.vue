...
export default {
    ...
    methods: {
        ...
        download_clicked(hid) {
            ...
            // window.location.href = "http://ipv4.download.thinkbroadband.com/50MB.zip"
        },
    ...
    mounted() {
        ...
        axios.post(`${this.server_address}/link`, {
